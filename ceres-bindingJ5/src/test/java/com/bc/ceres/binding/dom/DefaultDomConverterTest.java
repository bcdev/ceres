...
public class DefaultDomConverterTest extends TestCase {
    ...
    public static void assertEquals(String message, Xpp3Dom expected, Xpp3Dom actual) {
        ...
        if (expected.getChildCount() == 0) {
            ...
            assertTrue(message, expected.getValue() == null || StringUtil.isEmpty(expected.getValue().trim()));
            assertTrue(message, actual.getValue() == null || StringUtil.isEmpty(actual.getValue().trim()));
        }
