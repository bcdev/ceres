 ...
 * well as blank lines, are ignored. The comment character is <tt>'#'</tt> (<tt>'&#92;u0023'</tt>
 * , <font size="-1">NUMBER SIGN</font>); on each line all characters following
 ...
 * 
 * <pre>
 * private static ServiceLoader&lt;CodecSet&gt; codecSetLoader = ServiceLoader
 * 		.load(CodecSet.class);
 * </pre>
 * 
 * </blockquote>
